namespace Input2 {
   partial class Form1 {
      ...
      private void InitializeComponent() {
         ...
         this.numericUpDown_maxdiffTabItem = new System.Windows.Forms.NumericUpDown();
         ...
         this.numericUpDown_Shrink = new System.Windows.Forms.NumericUpDown();
         this.label6 = new System.Windows.Forms.Label();
         this.numericUpDown_maxdiffEncoder = new System.Windows.Forms.NumericUpDown();
         ...
         ((System.ComponentModel.ISupportInitialize)(this.numericUpDown_maxdiffTabItem)).BeginInit();
         ...
         ((System.ComponentModel.ISupportInitialize)(this.numericUpDown_Shrink)).BeginInit();
         ((System.ComponentModel.ISupportInitialize)(this.numericUpDown_maxdiffEncoder)).BeginInit();
    ...
    "0 .   !11 .   !12 .   !13 .   !14 .   !15 .   !";
         ...
         this.numericUpDown_MinBytes.TabIndex = 3;
         this.numericUpDown_MinBytes.ValueChanged += new System.EventHandler(this.numericUpDown_MinBytes_ValueChanged);
         // 
         // label5
         // 
         ...
         this.label5.Text = "Bereichslänge:";
         // 
         // textBox_int
         // 
         ...
         // 
         // numericUpDown_maxdiffTabItem
         // 
         this.numericUpDown_maxdiffTabItem.Location = new System.Drawing.Point(82, 58);
         this.numericUpDown_maxdiffTabItem.Maximum = new decimal(new int[] {
            65536,
            0,
            0,
            0});
         this.numericUpDown_maxdiffTabItem.Name = "numericUpDown_maxdiffTabItem";
         this.numericUpDown_maxdiffTabItem.Size = new System.Drawing.Size(51, 20);
         this.numericUpDown_maxdiffTabItem.TabIndex = 5;
         this.numericUpDown_maxdiffTabItem.Value = new decimal(new int[] {
            158,
            0,
            0,
            0});
         this.numericUpDown_maxdiffTabItem.ValueChanged += new System.EventHandler(this.numericUpDown_maxdiff_ValueChanged);
         // 
         // label7
         // 
         ...
         this.label9.Location = new System.Drawing.Point(498, 80);
         ...
         this.numericUpDown_TilesizeHoriz.Location = new System.Drawing.Point(563, 75);
         ...
         this.numericUpDown_TilesizeHoriz.TabIndex = 7;
         ...
         this.groupBox4.Controls.Add(this.textBox_ShrinkAdr);
         this.groupBox4.Controls.Add(this.numericUpDown_Shrink);
         this.groupBox4.Controls.Add(this.label6);
         this.groupBox4.Location = new System.Drawing.Point(441, 111);
         this.groupBox4.Name = "groupBox4";
         this.groupBox4.Size = new System.Drawing.Size(186, 65);
         this.groupBox4.TabIndex = 12;
         this.groupBox4.TabStop = false;
         this.groupBox4.Text = "Zoomlevel";
         // 
         // label14
         // 
         ...
         this.label14.Text = "Adr. (hex):";
         // 
         // textBox_ShrinkAdr
         // 
         this.textBox_ShrinkAdr.Location = new System.Drawing.Point(108, 32);
         this.textBox_ShrinkAdr.Name = "textBox_ShrinkAdr";
         this.textBox_ShrinkAdr.Size = new System.Drawing.Size(61, 20);
         this.textBox_ShrinkAdr.TabIndex = 3;
         // 
         // numericUpDown_Shrink
         // 
         this.numericUpDown_Shrink.Location = new System.Drawing.Point(62, 32);
         this.numericUpDown_Shrink.Maximum = new decimal(new int[] {
            99,
            0,
            0,
            0});
         this.numericUpDown_Shrink.Name = "numericUpDown_Shrink";
         this.numericUpDown_Shrink.Size = new System.Drawing.Size(37, 20);
         this.numericUpDown_Shrink.TabIndex = 2;
         this.numericUpDown_Shrink.ValueChanged += new System.EventHandler(this.numericUpDown_Shrink_ValueChanged);
         // 
         // label6
         // 
         ...
         // 
         // numericUpDown_maxdiffEncoder
         // 
         this.numericUpDown_maxdiffEncoder.Location = new System.Drawing.Point(527, 186);
         this.numericUpDown_maxdiffEncoder.Maximum = new decimal(new int[] {
            65536,
            0,
            0,
            0});
         this.numericUpDown_maxdiffEncoder.Name = "numericUpDown_maxdiffEncoder";
         this.numericUpDown_maxdiffEncoder.Size = new System.Drawing.Size(74, 20);
         this.numericUpDown_maxdiffEncoder.TabIndex = 14;
         this.numericUpDown_maxdiffEncoder.ValueChanged += new System.EventHandler(this.numericUpDown_maxdiffEncoder_ValueChanged);
         // 
         // label13
         // 
         this.label13.AutoSize = true;
         this.label13.Location = new System.Drawing.Point(438, 188);
         this.label13.Name = "label13";
         this.label13.Size = new System.Drawing.Size(83, 13);
         this.label13.TabIndex = 13;
         this.label13.Text = "Encodermaxdiff:";
         // 
         // groupBox3
         // 
         this.groupBox3.Controls.Add(this.label8);
         this.groupBox3.Controls.Add(this.textBox_PatchPos);
         this.groupBox3.Controls.Add(this.label5);
         this.groupBox3.Controls.Add(this.numericUpDown_MinBytes);
         this.groupBox3.Controls.Add(this.checkBox_FillBits);
         this.groupBox3.Location = new System.Drawing.Point(231, 111);
         this.groupBox3.Name = "groupBox3";
         this.groupBox3.Size = new System.Drawing.Size(200, 101);
         this.groupBox3.TabIndex = 11;
         this.groupBox3.TabStop = false;
         this.groupBox3.Text = "DEM-Datenbereich";
         // 
         // label8
         // 
         ...
         this.label8.Text = "Startadr. (hex):";
         // 
         // groupBox6
         // 
         this.groupBox6.Controls.Add(this.label1);
         this.groupBox6.Controls.Add(this.numericUpDown_Codingtype);
         this.groupBox6.Controls.Add(this.textBox_CodingtypeAdr);
         this.groupBox6.Controls.Add(this.label17);
         this.groupBox6.Controls.Add(this.label16);
         this.groupBox6.Controls.Add(this.textBox_MaxHeightDiffAdr);
         this.groupBox6.Controls.Add(this.numericUpDown_maxdiffTabItem);
         this.groupBox6.Controls.Add(this.textBox_BaseHeightAdr);
         this.groupBox6.Controls.Add(this.label11);
         this.groupBox6.Controls.Add(this.numericUpDown_Min);
         this.groupBox6.Location = new System.Drawing.Point(9, 111);
         this.groupBox6.Name = "groupBox6";
         this.groupBox6.Size = new System.Drawing.Size(216, 115);
         this.groupBox6.TabIndex = 10;
         this.groupBox6.TabStop = false;
         this.groupBox6.Text = "Tableitem";
         // 
         // label1
         // 
         ...
         this.label1.Text = "Adr. (hex):";
         // 
         // numericUpDown_Codingtype
         // 
         this.numericUpDown_Codingtype.Location = new System.Drawing.Point(82, 84);
         ...
         this.numericUpDown_Codingtype.TabIndex = 8;
         ...
         this.label16.Text = "max. Diff.:";
         // 
         // textBox_MaxHeightDiffAdr
         // 
         this.textBox_MaxHeightDiffAdr.Location = new System.Drawing.Point(139, 58);
         ...
         this.textBox_MaxHeightDiffAdr.TabIndex = 6;
         // 
         // textBox_BaseHeightAdr
         // 
         this.textBox_BaseHeightAdr.Location = new System.Drawing.Point(139, 32);
         this.textBox_BaseHeightAdr.Name = "textBox_BaseHeightAdr";
         this.textBox_BaseHeightAdr.Size = new System.Drawing.Size(61, 20);
         this.textBox_BaseHeightAdr.TabIndex = 3;
         // 
         // label11
         // 
         ...
         // numericUpDown_Min
         // 
         this.numericUpDown_Min.Location = new System.Drawing.Point(82, 32);
         ...
         this.numericUpDown_TilesizeVert.Location = new System.Drawing.Point(631, 75);
         ...
         this.numericUpDown_TilesizeVert.TabIndex = 9;
         ...
         this.label15.Location = new System.Drawing.Point(615, 80);
         ...
         this.textBox_ExternArgs.Location = new System.Drawing.Point(542, 90);
         this.textBox_ExternArgs.Name = "textBox_ExternArgs";
         this.textBox_ExternArgs.Size = new System.Drawing.Size(161, 20);
         this.textBox_ExternArgs.TabIndex = 10;
         // 
         // label12
         // 
         this.label12.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
         this.label12.AutoSize = true;
         this.label12.Location = new System.Drawing.Point(475, 93);
         ...
         this.MinimumSize = new System.Drawing.Size(735, 649);
         this.Name = "Form1";
         this.Text = "Input";
         this.Load += new System.EventHandler(this.Form1_Load);
         this.Shown += new System.EventHandler(this.Form1_Shown);
         ((System.ComponentModel.ISupportInitialize)(this.numericUpDown_MinBytes)).EndInit();
         ((System.ComponentModel.ISupportInitialize)(this.numericUpDown_maxdiffTabItem)).EndInit();
         ...
         ((System.ComponentModel.ISupportInitialize)(this.numericUpDown_Shrink)).EndInit();
         ((System.ComponentModel.ISupportInitialize)(this.numericUpDown_maxdiffEncoder)).EndInit();
      ...
      private System.Windows.Forms.NumericUpDown numericUpDown_maxdiffTabItem;
      ...
      private System.Windows.Forms.NumericUpDown numericUpDown_maxdiffEncoder;
      private System.Windows.Forms.Label label13;
      private System.Windows.Forms.NumericUpDown numericUpDown_Shrink;
